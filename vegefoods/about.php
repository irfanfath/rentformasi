    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Selamat datang di Rentformasi eCommerce website</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
      ...
      <div class="container">
          <div class="row justify-content-center">
              <div class="col-md-10 mb-5 text-center">
                <ul class="product-category">
                  <li><a href="#w3sec1" class="active">FAQ's</a></li>
                  <li><a href="#w3sec2">Kontak Kami</a></li>
                  <li><a href="#w3sec3">Syarat Dan Ketentuan</a></li>
                  <li><a href="#w3sec4">Kebijakan Privasi</a></li>
                  <li><a href="#w3sec5">Panduan Penggunaan</a></li>
                </ul>
              </div>
          </div>

        <section class="ftco-section ftco-degree-bg">
          <div id="w3sec1" class="container">
              <div class="row justify-content-center mb-3 pb-3">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                      <span class="subheading">FAQ's</span>
                      <h2 class="mb-4">Frequently Ask Question</h2>
        ...
        <div id="w3sec2" class="container">
          <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section ftco-animate text-center">
              <span class="subheading">Kontak</span>
              <h2 class="mb-4">Hubungi Kami</h2>
              <p>Untuk Informasi Lebih Jelas Silahkan Hubungi Kami</p>
            </div>
          </div>
        </div>
        ...
        <section class="ftco-section ftco-degree-bg">
          <div id="w3sec3" class="container">
            <div class="row justify-content-center mb-5 pb-3">
              <div class="col-md-7 heading-section ftco-animate text-center">
                <span class="subheading">S&K</span>
                <h2 class="mb-4">Syarat & Ketentuan</h2>
                <p>Silahkan cermati aturan yang berlaku</p>
              </div>
            </div>
          </div>
          <div class="container">
          ...
          <div class="col-md-10 mb-5 text-center">
            <ul class="product-category">
              <li><a href="#" class="active">Ketentuan Penyewa</a></li>
              <li><a href="#">Ketentuan Vendor</a></li>
              <li><a href="#">Ketentuan Transaksi</a></li>
              <li><a href="#">Syarat Barang</a></li>
            </ul>
          </div>
        </div>
            <div class="row">
        ...
        <section class="ftco-section ftco-degree-bg">
          <div id="w3sec4" class="container">
            <div class="row justify-content-center mb-5 pb-3">
              <div class="col-md-7 heading-section ftco-animate text-center">
                <span class="subheading">Term Of Condition</span>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 ftco-animate">
                ...
                <h2 class="mb-3 mt-5">3. Creative WordPress Themes</h2>
                <p>Temporibus ad error suscipit exercitationem hic molestiae totam obcaecati rerum, eius aut, in. Exercitationem atque quidem tempora maiores ex architecto voluptatum aut officia doloremque. Error dolore voluptas, omnis molestias odio dignissimos culpa ex earum nisi consequatur quos odit quasi repellat qui officiis reiciendis incidunt hic non? Debitis commodi aut, adipisci.</p>
                  ...
                  <div class="col-md-12 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch d-md-flex">
                      ...
                      <div class="text d-block pl-md-4">
                        ...
                        <h3 class="heading"><a href="blog-single.php">Cara Menyewa</a></h3>
                  ...
                  <div class="col-md-12 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch d-md-flex">
                      ...
                      <div class="text d-block pl-md-4">
                        ...
                        <h3 class="heading"><a href="#">Cara Menjadi Vendor</a></h3>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <p><a href="blog-single.php" class="btn btn-primary py-2 px-3">Read more</a></p>
                      </div>
                    </div>
