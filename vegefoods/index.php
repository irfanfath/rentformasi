		...
		<section class="ftco-section ftco-category ftco-no-pt">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<div class="row">
							<div class="col-md-6 order-md-last align-items-stretch d-flex">
								<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(images/jasa.png);">
									<div class="text text-center">
										<h2>Jasa </h2>
										<p>Kami Menyediakan berbagai jasa untuk memenuhi kebutuhan anda</p>
										<p><a href="jasa.php" class="btn btn-primary">Lihat Jasa Lainnya</a></p>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/event.jpg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="#">Event Organizer</a></h2>
									</div>
								</div>
								<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(images/weeding.jpg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="#">Weeding Planner</a></h2>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/interior.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="#">Desainer Rumah</a></h2>
							</div>		
						</div>
						<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(images/touguide.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="#">Tour Guide</a></h2>
							</div>
						</div>
					</div>       
				</div>
    		...
    		<div class="row justify-content-center">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        <span class="subheading">Barang terpopuler</span>
                            <h3 class="mb-4">Paling Banyak Disewa</h3>
                                
                    </div>
                <div class="col-md-10 mb-5 text-center">
                    <ul class="nav product-category justify-content-center">
                        <li><a class="active" data-toggle="tab" href="#all">All</a></li>
                        <li><a data-toggle="tab" href="#home">Mobil & Motor</a></li>
                        <li><a data-toggle="tab" href="#menu1">Alat Elektronik</a></li>
                        <li><a data-toggle="tab" href="#menu2">Alat Berat</a></li>
                        <li><a data-toggle="tab" href="#menu3">Hobi</a></li>
                    </ul>
                </div>
            </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
          	<span class="subheading">Promosi</span>
            <h2 class="mb-4">Dapatkan Voucher Menarik</h2>
              	...
              	<div class="item">
	                <div class="testimony-wrap p-4 pb-5">
	                  ...
	                  <div class="text text-center">
	                    ...
	                    <p class="name">Voucher Canon</p>
	                    <span class="position">Diskon 20%</span>
	                  </div>
	                </div>
              	</div>
              	<div class="item">
